...
| *"add some fun small animations like the forrest"* | Lights and birds. Both rates were wrong on the first pass (7.6 window changes a second, birds on screen 76% of the time) and `citytest.ts` caught both before Leo saw them. |
