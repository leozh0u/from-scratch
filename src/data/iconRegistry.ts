...
export const COMPOSED: Record<string, { form: FormId; colour: string }> = {
  speaker: { form: 'machine', colour: '#3a3a52' },
  microphone: { form: 'tool', colour: '#5a5a72' },
  headphones: { form: 'machine', colour: '#772222' },
  record: { form: 'wheel', colour: '#1a1a20' },
  wire_mesh: { form: 'cloth', colour: '#98a0ac' },
  fencing_mask: { form: 'machine', colour: '#7a828e' },
  fencing_blade: { form: 'tool', colour: '#c8ccd4' },
  fencing_kit: { form: 'cloth', colour: '#e8e8ee' },
  wool: { form: 'fibre', colour: '#efe6d6' },
  felt: { form: 'cloth', colour: '#772222' },
  ...
  linen: { form: 'cloth', colour: '#846315' },
  flour: { form: 'powder', colour: '#f0e8d8' },
  dough: { form: 'lump', colour: '#e8d8b8' },
  bread: { form: 'lump', colour: '#b8783a' },
  beer: { form: 'bottle', colour: '#d8a33a' },
  vinegar: { form: 'bottle', colour: '#772222' },
  knife: { form: 'tool', colour: '#9aa0a8' },
  pot: { form: 'bottle', colour: '#a05a3a' },
  ...
  bicycle: { form: 'machine', colour: '#846315' },
  gear: { form: 'wheel', colour: '#8a7a5a' },
  clock: { form: 'wheel', colour: '#d8c48a' },
  engine: { form: 'machine', colour: '#417722' },
  ...
  steel_frame: { form: 'machine', colour: '#158454' },
  ...
  cart_wheel: { form: 'wheel', colour: '#846315' },
